...
\begin{frame}{Mapa de Calor: Corte en $z = -0.50$ km — Plano Superficial}
    ...
    \begin{columns}[T]
        ...
        \begin{exampleblock}{¿Qué nos dice?}
            \scriptsize
            A esta profundidad el modelo \textbf{no logra reproducir} las amplitudes observadas, lo que confirma que la fuente no está aquí.
        \end{exampleblock}
...
% FRAME 30c: z = -1.14
% -----------------------------------------------
\begin{frame}{Mapa de Calor: Corte en $z = -1.14$ km — Profundidad Estimada}

    \begin{columns}[T]

        \column{0.55\textwidth}

        \begin{block}{Corte en $z_{\text{est}} = -1.14$ km}
            \centering
        ...
        \begin{block}{Interpretación}
            \scriptsize
            \begin{itemize}
                \item Corresponde a la \textbf{profundidad estimada} por el optimizador numérico.
                \vspace{0.1cm}
                \item La región mínima sigue \textbf{bien definida} y muy cercana a la fuente real.
                \vspace{0.1cm}
                \item La diferencia con $z_{\text{real}} = -1.10$ km es mínima, indicando \textbf{estabilidad} del modelo.
            \end{itemize}
        \end{block}
        ...
        \begin{exampleblock}{¿Qué nos dice?}
            \scriptsize
            El optimizador encontró una profundidad \textbf{muy cercana a la real}, confirmando la coherencia entre estimación numérica y visualización.
        \end{exampleblock}
...
\begin{frame}{Mapa de Calor: Corte en $z = -1.70$ km — Plano Profundo}
    ...
    \begin{columns}[T]
        ...
        \begin{block}{Interpretación}
            \scriptsize
            \begin{itemize}
                \item Este plano está \textbf{por debajo} de $z_{\text{real}}$ y $z_{\text{est}}$.
                \vspace{0.1cm}
