    ...
    \begin{columns}[T]
        ...
        \begin{block}{Problema Directo}
            \begin{center}
                ...
                \scriptsize
                Conocemos los parámetros $\mathbf{m} = [x_{Real}, y_{Real}, z_{Real}, A_0]^T$ y calculamos las amplitudes esperadas.
            \end{center}
        \end{block}
        ...
        \begin{block}{Problema Inverso}
            \begin{center}
                ...
                \scriptsize
                A partir de las amplitudes observadas, estimamos el vector de parámetros $\mathbf{m} = [x_{Real}, y_{Real}, z_{Real}, A_0]^T$.
            \end{center}
        \end{block}
