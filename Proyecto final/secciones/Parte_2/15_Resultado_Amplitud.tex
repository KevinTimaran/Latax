    ...
    \begin{columns}[T]
        ...
        \begin{block}{Observaciones Clave}
            ...
            \begin{itemize}
                ...
                \item \textbf{La onda viaja una distancia muy corta:} 
                al estar más cerca de la fuente sísmica.
                
                \vspace{0.4cm}
                
                \item \textbf{La señal casi no pierde fuerza:} 
                por eso la amplitud registrada es mucho mayor.
            \end{itemize}
        \end{block}

        \vspace{0.6cm}
        \begin{center}
            \tiny \textit{Amplitudes calculadas mediante 
            $A_{ideal} = A_0 \frac{e^{-R}}{R}$ con $A_0=10$.}
        \end{center}
    \end{columns}
