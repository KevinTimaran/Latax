...
\begin{frame}{Modelo Geométrico de la Fuente Sísmica}
    \begin{figure}
        ...
        \begin{tikzpicture}[x={(0.866cm,-0.5cm)}, y={(0.866cm,0.5cm)}, z={(0cm,1cm)}, scale=0.6, transform shape]
            ...
            \node[anchor=west, text=gray!80!black] at (5.5, 5.5, 0) {Superficie Terrestre ($z=0$)};
            ...
            \node[below, font=\bfseries, text=red!80!black, yshift=-3mm] at (Hipocentro) {Fuente: $(x_{Real}, y_{Real}, z_{Real})$};
