...
\begin{frame}{Dataset Instrumental: Coordenadas y Amplitudes}
    \begin{block}{Tabla 1: Datos de entrada para la Función de Error}
        ...
        \begin{tabular}{@{}lcccc@{}}
            \toprule
            \textbf{Sensor} & \textbf{$x_i$ [km]} & \textbf{$y_i$ [km]} & \textbf{$z_i$ [km]} & \textbf{$Az_i$ observado} \\ \midrule
            ...
            \textbf{\textcolor{blue}{S9}}  & \textbf{\textcolor{blue}{0.5}} & \textbf{\textcolor{blue}{0.5}} & \textbf{\textcolor{blue}{0.0}} & \textbf{\textcolor{blue}{0.852201}} \\
